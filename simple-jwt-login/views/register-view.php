...
<div class="sjl-gen-card">
    <div class="sjl-gen-card-header">
        ...
        <div>
            <h3 class="sjl-gen-card-title"><?php echo __('User Registration', 'simple-jwt-login'); ?></h3>
            <p class="sjl-gen-card-desc">
                <?php echo __('Allow new users to register via the JWT API endpoint.', 'simple-jwt-login'); ?>
            </p>
        </div>
    </div>
...
<div class="sjl-gen-card">
    <div class="sjl-gen-card-header">
        ...
        <div>
            ...
            <p class="sjl-gen-card-desc">
                <?php echo __('If enabled, an additional Auth Code must be included in the registration request. Configure Auth Codes in the Auth Codes tab.', 'simple-jwt-login'); ?>
            </p>
        </div>
    </div>
    <div class="sjl-gen-card-body">
        ...
        >
            ...
            <?php echo __('Allowing registration without an Auth Code is not recommended. Anyone can create accounts on your site.', 'simple-jwt-login'); ?>
        </div>
    </div>
</div>
    ...
    <div class="sjl-gen-card-header">
        ...
        <div>
            <h3 class="sjl-gen-card-title">
                ...
                ?>
                <?php echo __('New User Settings', 'simple-jwt-login'); ?>
            </h3>
            <p class="sjl-gen-card-desc">
                <?php echo __('Configure the default role and password behaviour for newly registered users.', 'simple-jwt-login'); ?>
            </p>
        </div>
    </div>
    <div class="sjl-gen-card-body">
        ...
        <div class="sjl-gen-feature-item">
            ...
            <p class="sjl-gen-feature-desc">
                ...
                <?php echo __('Common values:', 'simple-jwt-login'); ?>
                ...
                &mdash; <a href="https://wordpress.org/support/article/roles-and-capabilities/" target="_blank"><?php echo __('full list', 'simple-jwt-login'); ?></a>
            </p>
            <input type="text" name="new_user_profile" id="new_user_profile" class="form-control sjl-gen-input-medium"
                   ...
                   placeholder="<?php echo __('e.g. subscriber', 'simple-jwt-login'); ?>"
            />
        </div>
        ...
        <div class="sjl-gen-feature-toggle">
            ...
            <div class="sjl-gen-feature-toggle-text">
                <label for="random_password" class="sjl-gen-feature-label">
                    <?php echo __('Generate a random password', 'simple-jwt-login'); ?>
                </label>
                <p class="sjl-gen-feature-desc">
                    <?php echo __('When enabled, a secure random password is generated automatically and the password field is not required in the registration request.', 'simple-jwt-login'); ?>
                </p>
                <div class="sjl-gen-inline-field" style="margin-top:8px;">
                    <label class="sjl-gen-field-label" for="random_password_length" style="display:inline-block;margin-right:8px;">
                        ...
                        echo __('Password length:', 'simple-jwt-login');
                        ?>
                    </label>
                    <input type="text" name="random_password_length" id="random_password_length"
                           ...
                           placeholder="12"
                    />
                    <span class="sjl-gen-card-desc" style="margin-left:6px;"><?php echo __('characters', 'simple-jwt-login'); ?></span>
                </div>
            </div>
        </div>
...
<div class="sjl-gen-card">
    <div class="sjl-gen-card-header">
        ...
        <div>
            <h3 class="sjl-gen-card-title"><?php echo __('Post-Registration Options', 'simple-jwt-login'); ?></h3>
            <p class="sjl-gen-card-desc">
                <?php echo __('What happens immediately after a user is successfully registered.', 'simple-jwt-login'); ?>
            </p>
        </div>
    </div>
    <div class="sjl-gen-card-body">
        ...
        <div class="sjl-gen-feature-toggle">
            ...
            <div class="sjl-gen-feature-toggle-text">
                <label for="register_force_login" class="sjl-gen-feature-label">
                    <?php echo __('Auto-login after registration', 'simple-jwt-login'); ?>
                </label>
                <p class="sjl-gen-feature-desc">
                    <?php echo __('Automatically authenticates the new user after successful registration, using the Login tab redirect settings. Requires Auto-Login to be enabled.', 'simple-jwt-login'); ?>
                </p>
            </div>
        </div>
        ...
        <div class="sjl-gen-feature-toggle">
            ...
            <div class="sjl-gen-feature-toggle-text">
                <label for="register_jwt" class="sjl-gen-feature-label">
                    <?php echo __('Return a JWT in the registration response', 'simple-jwt-login'); ?>
                </label>
                <p class="sjl-gen-feature-desc">
                    <?php echo __('Includes a signed JWT in the API response. The payload contains email, user ID, and username by default. If Authentication is configured, the payload follows those settings instead.', 'simple-jwt-login'); ?>
                </p>
            </div>
        </div>
...
<div class="sjl-gen-card">
    <div class="sjl-gen-card-header">
        ...
        <div>
            ...
            <p class="sjl-gen-card-desc">
                <?php echo __('Restrict registrations by IP address or email domain. Leave fields blank to allow all.', 'simple-jwt-login'); ?>
            </p>
        </div>
    </div>
    <div class="sjl-gen-card-body">
        <div class="sjl-gen-two-col">
            ...
            <div class="sjl-gen-two-col-right">
                <label class="sjl-gen-field-label" for="register_domain">
                    <?php echo __('Allowed Email Domains', 'simple-jwt-login'); ?>
                </label>
                <input type="text" id="register_domain" name="register_domain" class="form-control"
                       ...
                       placeholder="<?php echo __('e.g. gmail.com, company.org', 'simple-jwt-login'); ?>"
                />
                <p class="sjl-gen-card-desc" style="margin-top:4px;">
                    <?php echo __('Comma-separated. Leave blank to allow all domains.', 'simple-jwt-login'); ?>
                </p>
            </div>
        </div>
    </div>
...
<div class="sjl-gen-card">
    <div class="sjl-gen-card-header">
        ...
        <div>
            <h3 class="sjl-gen-card-title"><?php echo __('User Data', 'simple-jwt-login'); ?></h3>
            <p class="sjl-gen-card-desc">
                <?php echo __('Control which extra user properties and meta keys can be set during registration.', 'simple-jwt-login'); ?>
            </p>
        </div>
    </div>
    <div class="sjl-gen-card-body">
        ...
        <div class="sjl-gen-feature-item">
            <label class="sjl-gen-feature-label" for="allowed_user_meta">
                <?php echo __('Allowed User Meta Keys', 'simple-jwt-login'); ?>
            </label>
            <p class="sjl-gen-feature-desc">
                <?php echo __('Comma-separated list of <code>user_meta</code> keys that may be set during registration. Leave blank to disallow all meta.', 'simple-jwt-login'); ?>
            ...
            <input type="text" class="form-control sjl-gen-input-medium" name="allowed_user_meta" id="allowed_user_meta"
                   ...
                   placeholder="<?php echo __('e.g. my_meta1, my_meta2', 'simple-jwt-login'); ?>"
            />
        </div>

        <!-- Available properties reference -->
        <div class="sjl-gen-feature-item" style="border-bottom:none;padding-bottom:0;">
            <p class="sjl-gen-feature-label"><?php echo __('Available User Properties', 'simple-jwt-login'); ?></p>
            <p class="sjl-gen-feature-desc" style="margin-bottom:10px;">
                <?php echo __('These standard WordPress user properties can be included in the registration POST body.', 'simple-jwt-login'); ?>
            </p>
