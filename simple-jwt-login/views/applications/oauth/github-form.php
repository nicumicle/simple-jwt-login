 ...
 */
?>
<form method="GET" action="<?php echo esc_url(GithubOauthApplication::AUTH_URL); ?>"
      class="simple-jwt-login-oauth-app github">
    <input type="hidden" name="client_id" value="<?php echo esc_attr($jwtSettings->getApplicationsSettings()->github()->getClientId()); ?>" />
    ...
    <button name="github-auth" class="simple-jwt-login-auth-btn">
        <img src="<?php echo esc_url($pluginDirUrl . 'images/applications/github-icon.svg'); ?>" alt="GitHub logo"/>
