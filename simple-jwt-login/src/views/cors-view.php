...
<div class="row mb-4">
    <div class="col-md-4">
        <input type="checkbox" name="cors[allow_origin_enabled]"
               value="1" <?php echo $jwtSettings->getCors()->isAllowOriginEnabled() ? 'checked' : '' ?> />
        <b>Access-Control-Allow-Origin</b>
    </div>
    <div class="col-md-8">
        <input type="text" class="form-control" name="cors[allow_origin]"
               value="<?php echo $jwtSettings->getCors()->getAllowOrigin(); ?>"/>
...
<div class="row mb-4">
    <div class="col-md-4">
        <input type="checkbox" name="cors[allow_methods_enabled]"
               value="1" <?php echo $jwtSettings->getCors()->isAllowMethodsEnabled() ? 'checked' : '' ?> />
        <b>Access-Control-Allow-Methods</b>
    </div>
    <div class="col-md-8">
        <input type="text" class="form-control" name="cors[allow_methods]"
               value="<?php echo $jwtSettings->getCors()->getAllowMethods(); ?>"/>
...
<div class="row mb-4">
    <div class="col-md-4">
        <input type="checkbox" name="cors[allow_headers_enabled]"
               value="1" <?php echo $jwtSettings->getCors()->isAllowHeadersEnabled() ? 'checked' : '' ?> />
        <b>Access-Control-Allow-Headers</b>
    </div>
    <div class="col-md-8">
        <input type="text" class="form-control" name="cors[allow_headers]"
               value="<?php echo $jwtSettings->getCors()->getAllowHeaders(); ?>"/>
