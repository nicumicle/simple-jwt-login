...
<div class="row">
    <div class="col-md-12">
        <h3 class="section-title"><?php echo __('CORS Headers Configuration', 'simple-jwt-login'); ?></h3>
        <p class="text-muted">
            <?php echo __('Configure which CORS headers to include in API responses.', 'simple-jwt-login'); ?>
        </p>
    </div>
</div>
