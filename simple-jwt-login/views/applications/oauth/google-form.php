 ...
 */
?>
<form method="POST" action="<?php echo esc_url(GoogleOauthApplication::AUTH_URL);?>" class="simple-jwt-login-oauth-app google">
    ...
    <button name="google-auth" class="simple-jwt-login-auth-btn">
        <img src="<?php echo esc_url($pluginDirUrl . 'images/applications/google-icon.svg');?>" alt="google logo"/>
