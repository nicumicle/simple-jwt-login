...
class ErrorCodes
{
    ...
    const ERR_AUTHENTICATION_IS_NOT_ENABLED = 45;
    const ERR_AUTHENTICATION_MISSING_EMAIL = 46;
    const ERR_AUTHENTICATION_MISSING_PASSWORD = 47;
    const ERR_AUTHENTICATION_WRONG_CREDENTIALS = 48;
    ...
    const ERR_AUTH_CODE_REQUIRED = 94;
    const ERR_INVALID_EMAIL_FOR_CHANGE_PASSWORD = 95;
    const ERR_INVALID_EMAIL_FOR_RESET_PASSWORD = 96;

    const ERR_MISSING_FACEBOOK_PARAM    = 97;
    const ERR_FACEBOOK_INVALID_CODE     = 98;
    const ERR_FACEBOOK_INVALID_TOKEN    = 99;
    const ERR_FACEBOOK_USER_NOT_FOUND   = 100;

    const ERR_MISSING_GITHUB_PARAM    = 101;
    ...
    const ERR_AUTH0_EMAIL_NOT_VERIFIED  = 111;
    const ERR_GITHUB_EMAIL_NOT_VERIFIED = 112;

    const ERR_AUTHENTICATION_PASSWORD_HASH_NOT_ALLOWED = 113;

    const ERR_PROTECT_ENDPOINTS_INSUFFICIENT_ROLE = 114;

    const ERR_REVOKED_TOKEN_UNAUTHORIZED  = 115;
    const ERR_REVOKED_TOKEN_NOT_FOUND     = 116;
    const ERR_REVOKED_TOKEN_DELETE_FAILED = 117;
}
